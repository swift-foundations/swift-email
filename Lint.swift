...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-email open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-email project authors
...
// it only while swift-email and swift-institute-linter-rules are both
...
Lint.run(dependencies: [
    ...
    // If swift-email owns a brand vocabulary, narrow with
